...
-- Volcando estructura de base de datos para sgcmdb
CREATE DATABASE IF NOT EXISTS `sgcmdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sgcmdb`;

-- Volcando estructura para tabla sgcmdb.access
CREATE TABLE IF NOT EXISTS `access` (
  `acc_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `acc_operid` tinyint unsigned NOT NULL,
  `acc_profileid` tinyint unsigned NOT NULL,
  `acc_state` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`acc_id`),
  KEY `FK_Per_Perfil_idx` (`acc_profileid`),
  KEY `FK_Per_Operacion_idx` (`acc_operid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.access: ~0 rows (aproximadamente)

-- Volcando estructura para tabla sgcmdb.doctypes
CREATE TABLE IF NOT EXISTS `doctypes` (
  `tdoc_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `tdoc_name` varchar(45) NOT NULL,
  `tdoc_abrev` varchar(3) NOT NULL,
  `tdoc_icon` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`tdoc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.doctypes: ~4 rows (aproximadamente)
REPLACE INTO `doctypes` (`tdoc_id`, `tdoc_name`, `tdoc_abrev`, `tdoc_icon`) VALUES
	(1, 'Documento Nacional Identidad', 'DNI', '/Recursos/Imagenes/DNI.png'),
	(2, 'Carnet Extranjeria', 'CEE', '/Recursos/Imagenes/cee.jpg'),
	(3, 'Permiso Temporal Trabajo', 'PTT', '/Recursos/Imagenes/cee.jpg'),
	(4, 'Pasaporte', 'PSP', '/Recursos/Pasaporte3936.jpg');

-- Volcando estructura para tabla sgcmdb.emails
CREATE TABLE IF NOT EXISTS `emails` (
  `email_link` varchar(45) NOT NULL,
  `email_personid` varchar(15) NOT NULL,
  `email_type` tinyint DEFAULT NULL,
  `email_state` tinyint DEFAULT NULL,
  PRIMARY KEY (`email_link`),
  UNIQUE KEY `email_link_UNIQUE` (`email_link`),
  KEY `FK_perId_idx` (`email_personid`),
  KEY `fk_emailType_idx` (`email_type`),
  CONSTRAINT `FK_email_perId` FOREIGN KEY (`email_personid`) REFERENCES `persons` (`person_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.emails: ~2 rows (aproximadamente)
REPLACE INTO `emails` (`email_link`, `email_personid`, `email_type`, `email_state`) VALUES
	('lagrp@gmail.com', '118019482', 0, 1),
	('larp@cajatrujillo.com', '118019482', 0, 1);

-- Volcando estructura para tabla sgcmdb.emailtypes
CREATE TABLE IF NOT EXISTS `emailtypes` (
  `etype_id` tinyint NOT NULL AUTO_INCREMENT,
  `etype_name` varchar(45) NOT NULL,
  `etype_icon` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`etype_id`),
  UNIQUE KEY `etype_id_UNIQUE` (`etype_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.emailtypes: ~2 rows (aproximadamente)
REPLACE INTO `emailtypes` (`etype_id`, `etype_name`, `etype_icon`) VALUES
	(1, 'Personal', 'xxxxx'),
	(2, 'Empresarial', 'xxxxx');

-- Volcando estructura para tabla sgcmdb.genders
CREATE TABLE IF NOT EXISTS `genders` (
  `gen_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `gen_type` varchar(45) NOT NULL,
  PRIMARY KEY (`gen_id`),
  UNIQUE KEY `sex_id_UNIQUE` (`gen_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.genders: ~2 rows (aproximadamente)
REPLACE INTO `genders` (`gen_id`, `gen_type`) VALUES
	(1, 'Masculino'),
	(2, 'Femenino');

-- Volcando estructura para tabla sgcmdb.nets
CREATE TABLE IF NOT EXISTS `nets` (
  `net_url` varchar(255) NOT NULL,
  `net_personid` varchar(15) NOT NULL,
  `net_name` varchar(45) DEFAULT NULL,
  `net_ico` varchar(255) DEFAULT NULL,
  `net_state` tinyint unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`net_url`),
  UNIQUE KEY `net_url_UNIQUE` (`net_url`),
  KEY `Fk_PersonId_idx` (`net_personid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.nets: ~0 rows (aproximadamente)

-- Volcando estructura para tabla sgcmdb.operations
CREATE TABLE IF NOT EXISTS `operations` (
  `oper_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `oper_modid` tinyint unsigned NOT NULL,
  `oper_name` varchar(45) NOT NULL,
  `oper_nameview` varchar(45) NOT NULL,
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.operations: ~0 rows (aproximadamente)

-- Volcando estructura para tabla sgcmdb.patients
CREATE TABLE IF NOT EXISTS `patients` (
  `pac_id` int unsigned NOT NULL AUTO_INCREMENT,
  `pac_perid` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`pac_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.patients: ~0 rows (aproximadamente)

-- Volcando estructura para tabla sgcmdb.persons
CREATE TABLE IF NOT EXISTS `persons` (
  ...
  `per_photo` varchar(45) DEFAULT NULL,
  `per_createtime` datetime DEFAULT NULL,
  `per_edittime` datetime DEFAULT NULL,
  `per_canceltime` datetime DEFAULT NULL,
  PRIMARY KEY (`person_id`),
  UNIQUE KEY `Usu_NumDocId_UNIQUE` (`person_id`),
  KEY `FK_TipoDoc_idx` (`per_doctype`),
  KEY `FK_ubigeo_idx` (`per_ubigeo`),
  KEY `FK_genero_idx` (`per_genderid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.persons: ~1 rows (aproximadamente)
REPLACE INTO `persons` (`person_id`, `per_doctype`, `per_docnumber`, `per_name`, `per_secondname`, `per_surname`, `per_secondsurname`, `per_birthday`, `per_genderid`, `per_address`, `per_ubigeo`, `per_ruc`, `per_photo`, `per_createtime`, `per_edittime`, `per_canceltime`) VALUES
	('118019482', 1, '18019482', 'Luis', 'Angel Geronimo', 'Rios', 'Pozo', '1972-09-22 00:00:00', 1, 'Pj. Los Condores # 216, urb. Los Pinos', 130101, '20132243230', '/Recursos/Imagenes/118019482.png', '2023-07-16 00:00:00', '2023-07-16 00:00:00', '1900-01-01 00:00:00');

-- Volcando estructura para tabla sgcmdb.phoneoper
CREATE TABLE IF NOT EXISTS `phoneoper` (
  `opet_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `opet_name` varchar(45) NOT NULL,
  `opet_logo` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`opet_id`),
  UNIQUE KEY `opet_Id_UNIQUE` (`opet_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.phoneoper: ~4 rows (aproximadamente)
REPLACE INTO `phoneoper` (`opet_id`, `opet_name`, `opet_logo`) VALUES
	(5, 'Movistar', 'xxx'),
	(6, 'Claro', 'xxx'),
	(7, 'Entel', 'xxx'),
	(8, 'Bitel', 'xx');

-- Volcando estructura para tabla sgcmdb.phones
CREATE TABLE IF NOT EXISTS `phones` (
  `pho_number` varchar(9) NOT NULL,
  `pho_personid` varchar(15) NOT NULL,
  `pho_typeid` tinyint unsigned NOT NULL,
  `pho_operid` tinyint unsigned NOT NULL,
  `pho_state` tinyint unsigned NOT NULL,
  PRIMARY KEY (`pho_number`),
  UNIQUE KEY `tel_numero_UNIQUE` (`pho_number`),
  KEY `fk_Tel_Tipo_idx` (`pho_typeid`),
  KEY `fk_perId_idx` (`pho_personid`),
  KEY `fk_Tel_Oper_idx` (`pho_operid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.phones: ~3 rows (aproximadamente)
REPLACE INTO `phones` (`pho_number`, `pho_personid`, `pho_typeid`, `pho_operid`, `pho_state`) VALUES
	('555555', '118019482', 1, 5, 0),
	('98234567', '118019482', 3, 5, 1),
	('985051568', '118019482', 2, 5, 1);

-- Volcando estructura para tabla sgcmdb.phonetypes
CREATE TABLE IF NOT EXISTS `phonetypes` (
  `ttel_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `ttel_name` varchar(45) NOT NULL,
  `ttel_icon` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ttel_id`),
  UNIQUE KEY `ttel_Id_UNIQUE` (`ttel_id`) /*!80000 INVISIBLE */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.phonetypes: ~3 rows (aproximadamente)
REPLACE INTO `phonetypes` (`ttel_id`, `ttel_name`, `ttel_icon`) VALUES
	(1, 'Casa', NULL),
	(2, 'Trabajo', NULL),
	(3, 'Personal', NULL);

-- Volcando estructura para tabla sgcmdb.profile
CREATE TABLE IF NOT EXISTS `profile` (
  `profile_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `pro_level` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.profile: ~4 rows (aproximadamente)
REPLACE INTO `profile` (`profile_id`, `pro_level`) VALUES
	(1, 'SuperAdmini'),
	(2, 'Administrador'),
	(3, 'Usuario'),
	(4, 'Auxiliar');

-- Volcando estructura para tabla sgcmdb.states
CREATE TABLE IF NOT EXISTS `states` (
  `est_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `est_state` varchar(10) NOT NULL,
  PRIMARY KEY (`est_id`),
  UNIQUE KEY `est_id_UNIQUE` (`est_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.states: ~2 rows (aproximadamente)
REPLACE INTO `states` (`est_id`, `est_state`) VALUES
	(0, 'Baja'),
	(1, 'Activo');

-- Volcando estructura para tabla sgcmdb.ubdpto
CREATE TABLE IF NOT EXISTS `ubdpto` (
  `ubdep_id` tinyint unsigned NOT NULL,
  `ubdep_name` varchar(45) NOT NULL,
  PRIMARY KEY (`ubdep_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.ubdpto: ~25 rows (aproximadamente)
REPLACE INTO `ubdpto` (`ubdep_id`, `ubdep_name`) VALUES
	(1, 'Amazonas'),
	(2, 'Áncash'),
	(3, 'Apurímac'),
	(4, 'Arequipa'),
...
-- Volcando estructura para tabla sgcmdb.ubigeo
CREATE TABLE IF NOT EXISTS `ubigeo` (
  `ubdis_id` mediumint unsigned NOT NULL,
  `ubdis_name` varchar(45) NOT NULL,
  `ubdis_ubprovid` smallint unsigned NOT NULL,
  `ubdis_ubdepid` mediumint unsigned NOT NULL,
  PRIMARY KEY (`ubdis_id`),
  KEY `FK_UbDis_UbProv_idx` (`ubdis_ubprovid`),
  CONSTRAINT `FK_UbDis_UbProv` FOREIGN KEY (`ubdis_ubprovid`) REFERENCES `ubprov` (`ubprov_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.ubigeo: ~1,874 rows (aproximadamente)
REPLACE INTO `ubigeo` (`ubdis_id`, `ubdis_name`, `ubdis_ubprovid`, `ubdis_ubdepid`) VALUES
...
-- Volcando estructura para tabla sgcmdb.ubprov
CREATE TABLE IF NOT EXISTS `ubprov` (
  `ubprov_id` smallint unsigned NOT NULL,
  `ubprov_name` varchar(45) NOT NULL,
  `ubprov_ubdepid` tinyint unsigned NOT NULL,
  PRIMARY KEY (`ubprov_id`),
  KEY `FK_UbProv_UbDepa_idx` (`ubprov_ubdepid`),
  CONSTRAINT `FK_UbProv_UbDepa` FOREIGN KEY (`ubprov_ubdepid`) REFERENCES `ubdpto` (`ubdep_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.ubprov: ~196 rows (aproximadamente)
REPLACE INTO `ubprov` (`ubprov_id`, `ubprov_name`, `ubprov_ubdepid`) VALUES
	(101, 'Chachapoyas', 1),
	(102, 'Bagua', 1),
	(103, 'Bongará', 1),
	(104, 'Condorcanqui', 1),
...
-- Volcando estructura para tabla sgcmdb.users
CREATE TABLE IF NOT EXISTS `users` (
  `user_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
  `usu_personid` varchar(15) NOT NULL,
  `usu_profileid` tinyint unsigned NOT NULL,
  `usu_specialty` varchar(45) NOT NULL,
  `usu_colegiatura` varchar(45) NOT NULL,
  `usu_login` varchar(10) NOT NULL,
  `usu_password` varchar(32) NOT NULL,
  `usu_photo` varchar(45) DEFAULT NULL,
  `usu_createtime` datetime DEFAULT NULL,
  `usu_edittime` datetime DEFAULT NULL,
  `usu_canceltime` datetime DEFAULT NULL,
  `usu_state` tinyint unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `Usu_NumDocId_UNIQUE` (`user_id`),
  KEY `FK_Usu_Perfil_idx` (`usu_profileid`),
  KEY `FK_usu_estado_idx` (`usu_state`),
  KEY `FK_usu_perId_idx` (`usu_personid`),
  CONSTRAINT `FK_usu_estado` FOREIGN KEY (`usu_state`) REFERENCES `states` (`est_id`),
  CONSTRAINT `FK_usu_Perfil` FOREIGN KEY (`usu_profileid`) REFERENCES `profile` (`profile_id`),
  CONSTRAINT `FK_usu_perId` FOREIGN KEY (`usu_personid`) REFERENCES `persons` (`person_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sgcmdb.users: ~1 rows (aproximadamente)
REPLACE INTO `users` (`user_id`, `usu_personid`, `usu_profileid`, `usu_specialty`, `usu_colegiatura`, `usu_login`, `usu_password`, `usu_photo`, `usu_createtime`, `usu_edittime`, `usu_canceltime`, `usu_state`) VALUES
	(1, '118019482', 1, 'Administrador', 'prueba', 'lagrp', 'luan3306', '/Recursos/Imagenes/118019482.png', '2023-07-16 00:00:00', '2023-07-16 00:00:00', '1900-01-01 00:00:00', 1);
