DROP TABLE IF EXISTS `ubprov`;
CREATE TABLE IF NOT EXISTS `ubprov` (
  `ubprov_id` smallint unsigned NOT NULL,
  `ubprov_name` varchar(45) NOT NULL,
  `ubprov_ubdep_id` tinyint unsigned NOT NULL,
  PRIMARY KEY (`ubprov_id`),
  KEY `FK_UbProv_UbDepa_idx` (`ubprov_ubdep_id`),
  CONSTRAINT `FK_UbProv_UbDepa` FOREIGN KEY (`ubprov_ubdep_id`) REFERENCES `ubdpto` (`ubdep_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;



INSERT INTO `ubprov` (`ubprov_id`, `ubprov_name`, `ubprov_ubdep_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
